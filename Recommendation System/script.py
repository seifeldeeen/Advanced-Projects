#This is a recommendation System for Movies
#it will include Action, Sci-Fi, Horror, and a lot more
#it will also include a function to recommend movies based on user input
